...
It shouldn't be hard to tell the government about an information security problem. In addition to .gov security contacts and security.txt files, consider ways to make it easier to discover where to send vulnerability reports to. For instance, you might add or update a page about your _security policy_ to your website, similar to how agencies link to their _privacy policy_, clearly linking your VDP to your agency's operational and security priorities.
...
**[Security contacts and the Organization field FAQ](#security-contacts-and-the-organization-field-faq)**
...
**[Security.txt FAQ](#securitytxt-faq)**
* [Do I need to have a security.txt file on every website in scope of our VDP?](#do-i-need-to-have-a-securitytxt-file-on-every-website-in-scope-of-our-vdp)
...
* [How should my agency think about the internet-accessible systems and services that are provided by service providers?](#how-should-my-agency-think-about-the-internet-accessible-systems-and-services-that-are-provided-by-service-providers)
...
* [Can my agency operate a bug bounty?](#can-my-agency-operate-a-bug-bounty)

**[Vulnerability reports](#vulnerability-reports-faq)**
* [How should we communicate with vulnerability reporters?](#how-should-we-communicate-with-vulnerability-reporters)
* [Do we need to respond to every vulnerability report?](#do-we-need-to-respond-to-every-vulnerability-report)
...
**[Miscellaneous](#miscellaneous-faq)**
...
#### Security.txt FAQ
##### Do I need to have a security.txt file on every website in scope of our VDP?
...
The directive applies to internet-accessible federal information systems, which encompasses those systems directly managed by an agency as well as those operated on an agency’s behalf. It also applies to [mobile applications](#systems-and-services).
...
Most systems will use a .gov domain. ([M-17-06](https://policy.cio.gov/web-policy/domain/) requires executive branch agencies to use a .gov or .mil address for their public-facing digital services and add any other domains used to a General Services Administration-maintained list.). Some actions, though, like defining a security contact or creating security.txt file, only apply to .gov domains.
...
##### How should my agency think about the internet-accessible systems and services that are provided by service providers?
The directive does not grant your agency the authority to force an organization you do business with to have a vulnerability disclosure policy. In fact, it is likely that your agency lacks authority to authorize testing on e.g., the cloud infrastructure or software as a service you use.

For certain applications, you may elect to work with the service provider to establish how your offerings could be added to your VDP. Carefully review the Department of Justice's guidance cited in the [third-party products and services](#third-party-products-and-services) section of our implementation guidance.

The most important thing is that there is a mechanism to _receive_ vulnerability information from the public (and for it to be relayed to the administrator of the system) than for allowance of "full-spectrum" security testing be done. Indeed, having a intake mechanism and easing its discovery is the initial goal of a VDP, but it's important your policy clearly outline what is and isn't in scope so vulnerability reporters aren't confused.
...
##### Can my agency operate a bug bounty?
...
##### Do we need to respond to every vulnerability report?
Where contact information is known, you should respond to every vulnerability report that is shared in good faith. (This means that you don't need to respond to reports that are obviously spam.) Even so, many reports shared with you will be unimportant or invalid. These need not necessarily be fixed at all or on a timely basis. Security teams should spend most of their attention on those with the greatest practical impact.

GSA/TTS has shared helpful [example responses](https://handbook.tts.gsa.gov/responding-to-public-disclosure-vulnerabilities/#3-respond-to-reporter) for reports that are apparently "not applicable".

##### How should my agency treat vulnerability reports from anonymous sources?
These reports should be treated the same as all other reports: like a gift.

Knowing the source of a report can be a real benefit because it allows for rapport to develop. However, if the person who submits a report isn't known, the claim should simply be evaluated on its merits (like every other report).
